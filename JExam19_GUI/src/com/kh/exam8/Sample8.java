...
class SubWindow {
	...
	public SubWindow() {
		...
		frm_sub.setSize(new Dimension(350, 200));
	...
	public void show() {
		frm_sub.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // 프레임만 닫음.
...
class MainWindow {
	...
	public MainWindow() {
		...
		btn3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showMessageDialog(frm_main, "알림 메세지 입니다.");
				// JOptionPane.showMessageDialog(frm_main, "알림 메세지 입니다.", "주의", JOptionPane.WARNING_MESSAGE);
				// JOptionPane.showMessageDialog(frm_main, "에러 메세지 입니다.", "에러", JOptionPane.ERROR_MESSAGE);
				// JOptionPane.showMessageDialog(frm_main, "질문 메세지 입니다.", "질문", JOptionPane.QUESTION_MESSAGE);
				
				// JOptionPane.showConfirmDialog(frm_main, "확인 다이얼로그");
				// JOptionPane.showConfirmDialog(frm_main, "확인 다이얼로그", "예/아니오",
				//		JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
				JOptionPane.showInputDialog(frm_main, "몇살이야?", JOptionPane.QUESTION_MESSAGE);
...
//		});
	...
	public void show() {
		frm_main.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  // 프로그램 종료
